 ...
 *
 * For booking-service that matters more than anywhere else: losing the race
 * for a seat is the single most common outcome under load.
 */
@Configuration
    ...
    public Customizer<Resilience4JCircuitBreakerFactory> defaultCircuitBreakerConfig() {
        ...
        CircuitBreakerConfig circuitBreakerConfig =
                CircuitBreakerConfig.custom()
                        ...
                        .ignoreExceptions(
                                // A seat that is already taken, or a user id
                                // that does not exist, is a normal answer from
                                // a perfectly healthy dependency. On a busy
                                // showtime these are common — counting them
                                // would open the circuit exactly when the
                                // system is busiest and working correctly.
                                SeatUnavailableException.class,
                                InvalidBookingReferenceException.class,
